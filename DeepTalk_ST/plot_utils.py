...
def plot_gene_sparsity(
    ...
    annotate_gene_sparsity(adata_1)
    annotate_gene_sparsity(adata_2)
...
def plot_cell_annotation(
    ...
    project_cell_annotations(adata_map, adata_sp, annotation=annotation)
